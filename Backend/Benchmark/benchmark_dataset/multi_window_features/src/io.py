...
from Backend.Benchmark.benchmark_dataset.multi_window_features.src.config import DEFAULT_INPUT_CSV, DEFAULT_OUTPUT_DIR
...
def write_multi_window_csv(dataframe: pd.DataFrame, output_path: Path) -> None:
