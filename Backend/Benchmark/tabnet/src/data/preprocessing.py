...
from Backend.Benchmark.tabnet.src.data.cleaning import (
...
from Backend.Benchmark.tabnet.src.data.contracts import PreparedDataset
from Backend.Benchmark.tabnet.src.data.feature_engineering import (
    build_gap_minutes_since_prev,
    build_local_time_features,
)
from Backend.Benchmark.tabnet.src.data.io import load_input_dataframe
from Backend.Benchmark.tabnet.src.data.splitting import build_split_slices


def prepare_pretraining_dataframe(config: PretrainConfig) -> PreparedDataset:
    source_df = load_input_dataframe(config.input_csv)
    validate_required_columns(source_df)
