...
from Backend.Benchmark.tabnet.src.data.contracts import DataPipelineResult, PreparedDataset
from Backend.Benchmark.tabnet.src.pipeline.data_pipeline import run_data_pipeline
from Backend.Benchmark.tabnet.src.pipeline.model_pipeline import run_model_pipeline
from Backend.Benchmark.tabnet.src.utils.artifacts import (
...
def run_pretraining_pipeline(config: PretrainConfig) -> dict[str, object]:
    ...
    artifacts = {
        "cleaned_pretrain_input_path": str(data_result.artifacts.cleaned_pretrain_input_path),
        ...
        "validation_loss_history_path": str(model_result.artifacts.validation_loss_history_path),
