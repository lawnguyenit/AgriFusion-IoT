...
def build_real_event_labels(
    *,
    ...
    source_csv = (aligned_csv or FUZZY_LOGIC_BASIC_DATASET_ROOT / "flb_input_aligned.csv").resolve()
    target_csv = (output_csv or FUZZY_LOGIC_BASIC_DATASET_ROOT / "flb_input_with_events.csv").resolve()
    report_path = target_csv.parent / "flb_real_event_labeling_report.json"
    ...
    report_payload = {
        ...
        "notes": [
            "flb_input_with_events.csv is the real-data label source of truth for downstream benchmarks.",
            "train-facing Layer2 and Layer3 exports only keep big_label in addition to their feature columns.",
        ],
    }
