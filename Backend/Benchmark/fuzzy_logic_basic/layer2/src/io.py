...
from Backend.Benchmark.fuzzy_logic_basic.layer2.src.config import DEFAULT_INPUT_CSV, DEFAULT_OUTPUT_DIR
...
def write_layer2_csv(dataframe: pd.DataFrame, output_path: Path) -> None:
