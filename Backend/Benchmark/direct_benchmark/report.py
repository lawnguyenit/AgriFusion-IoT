...
from Backend.Benchmark.direct_benchmark.src.pipeline.report_pipeline import run_report_pipeline


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate summary metrics and charts for a direct benchmark training run."
    )
    parser.add_argument(
        "--run-dir",
        type=Path,
