...
from Backend.Benchmark.weak_labels.compatibility.legacy_partitions import build_base_split_bundle
...
from Backend.Benchmark.weak_labels.compatibility.reporting import (
...
from Backend.Benchmark.weak_labels.compatibility.reporting.tranche0_contracts import build_tranche0_audit_artifacts
from Backend.Benchmark.weak_labels.compatibility.legacy_runtime.contracts import LabelArtifactBundle, WeakLabelsConfig, WeakLabelsResult
from Backend.Benchmark.weak_labels.compatibility.legacy_runtime.layout import (
    build_artifact_catalog,
    build_weak_labels_artifact_layout,
)
from Backend.Benchmark.weak_labels.infrastructure.shared.configs import PRIMARY_OUTPUT_FILES
from Backend.Benchmark.weak_labels.compatibility.legacy_v2 import build_v2_label_artifacts
