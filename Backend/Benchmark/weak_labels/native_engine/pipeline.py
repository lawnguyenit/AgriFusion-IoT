...
from Backend.Benchmark.weak_labels.native_engine.continuity_primitives import build_continuity_primitives, build_continuity_registry
from Backend.Benchmark.weak_labels.native_engine.derived_evidence import build_derived_evidence
from Backend.Benchmark.weak_labels.native_engine.inputs import load_e1_authorized_canonical
from Backend.Benchmark.weak_labels.native_engine.materialize import (
    build_intrinsic_candidate_assignments,
    build_semantic_fold_projection,
    materialize_from_assignments,
)
from Backend.Benchmark.weak_labels.native_engine.point_resolver import resolve_point_assignments
from Backend.Benchmark.weak_labels.native_engine.provenance import (
    build_label_source_dependency,
    build_rule_registry,
    build_threshold_registry,
    validate_referential_integrity,
)
from Backend.Benchmark.weak_labels.native_engine.publication import (
    copy_registry_with_native_stage,
    create_staging_directory,
    publish_staging_directory,
    write_artifact_catalog,
)
from Backend.Benchmark.weak_labels.native_engine.rules import evaluate_point_rules
from Backend.Benchmark.weak_labels.native_engine.runs import build_observed_low_runs
from Backend.Benchmark.weak_labels.native_engine.same_y_projection import build_same_y_transfer_projection
from Backend.Benchmark.weak_labels.native_engine.temporal_resolver import resolve_temporal_assignments
from Backend.Benchmark.weak_labels.native_engine.windows import build_window_projections
