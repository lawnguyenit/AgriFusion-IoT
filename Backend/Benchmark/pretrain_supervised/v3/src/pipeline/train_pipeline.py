...
from Backend.Benchmark.pretrain_supervised.v3.src.data.embeddings import build_experiment_embedding_bundle
...
def run_v3_pipeline(config: V3Config) -> dict[str, object]:
    config.validate()
