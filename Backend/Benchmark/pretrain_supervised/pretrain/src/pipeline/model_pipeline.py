...
from Backend.Benchmark.pretrain_supervised.pretrain.src.data.contracts import DataPipelineResult
from Backend.Benchmark.pretrain_supervised.pretrain.src.model.tabnet_pretrainer import (
    TabNetMaskedPretrainer,
    TrainingHistory,
)
from Backend.Benchmark.pretrain_supervised.pretrain.src.monitoring.writer import (
...
def run_model_pipeline(
    ...
    validation_loss_history_path = output_dir / "validation_reconstruction_loss.json"
