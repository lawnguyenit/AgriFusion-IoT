...
def _build_report(
    *,
    ...
    return {
        ...
        "split_policy": prepared.split_manifest,
...
def run_pretraining_pipeline(config: PretrainConfig) -> dict[str, object]:
    ...
    artifacts = {
        ...
        "split_manifest_path": str(data_result.artifacts.split_manifest_path),
        "split_train_path": str(data_result.artifacts.split_train_path),
        "split_validation_path": str(data_result.artifacts.split_validation_path),
        "split_test_path": str(data_result.artifacts.split_test_path),
        "split_excluded_gap_path": str(data_result.artifacts.split_excluded_gap_path),
