...
from Backend.Benchmark.pretrain_supervised.v4.src.data.embeddings import build_experiment_embedding_bundle


def run_v4_pipeline(config: V4Config) -> dict[str, object]:
    config.validate()
