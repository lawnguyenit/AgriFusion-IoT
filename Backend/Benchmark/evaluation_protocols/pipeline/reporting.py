...
def write_benchmark_readiness_report(
    *,
    ...
    lines = [
        ...
        "## Scope",
        "",
        "- Benchmark-ready scope in this run: `V0`, `V1`, and `V2 same-Y 3h`.",
        "- `V2 same-Y 8h` remains diagnostic-only here and is not part of the primary benchmark-ready contract.",
