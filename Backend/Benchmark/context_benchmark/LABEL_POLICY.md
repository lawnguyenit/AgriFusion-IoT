# Context Benchmark Label Policy
...
It is consumed here and rebuilt by the real-event-labeling stage inside `benchmark_dataset/`.

The canonical builder maps benchmark dataset labels into the selected contract.
...
- `synthetic_benchmark_gap_aware.csv`
