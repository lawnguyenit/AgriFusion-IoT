...
from Backend.Benchmark.context_benchmark.src.data.training_io import (
    load_tabular_bundle,
    load_tabular_split_frames,
)
from Backend.Benchmark.context_benchmark.src.scientific_artifacts import (
    probabilities_from_logits,
    write_context_scientific_artifacts,
)
from Backend.Benchmark.context_benchmark.src.scientific_charts import render_scientific_charts
...
def _finalize_scientific_result(
    *,
    ...
    render_scientific_charts(
        manifest=manifest,
        title_prefix=f"context_benchmark - {experiment_name} - {model_name}",
    )
