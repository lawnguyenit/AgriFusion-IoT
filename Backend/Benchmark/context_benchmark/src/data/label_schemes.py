...
def default_output_root(context_benchmark_root: Path, label_scheme_name: str) -> Path:
    return default_context_build_root(context_benchmark_root, label_scheme_name)
