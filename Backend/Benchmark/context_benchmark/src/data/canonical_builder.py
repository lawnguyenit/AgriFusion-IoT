...
from Backend.Benchmark.context_benchmark.src.data.contracts import BASE_SENSOR_COLUMNS, CANONICAL_COLUMNS
from Backend.Benchmark.context_benchmark.src.data.label_schemes import get_label_scheme
...
def build_real_canonical(real_event_csv: Path, label_scheme_name: str) -> pd.DataFrame:
    ...
    result["source_reference"] = "benchmark_input_labeled.csv"
