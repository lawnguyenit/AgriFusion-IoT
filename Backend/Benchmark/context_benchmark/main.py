...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build canonical real+synthetic context datasets for the context benchmark."
    )
    parser.add_argument(
        "--real-event-csv",
        type=Path,
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional output root. Defaults to Backend/Benchmark/context_benchmark/artifacts/builds/four_class/augmented.",
    )
    parser.add_argument(
        "--label-scheme",
