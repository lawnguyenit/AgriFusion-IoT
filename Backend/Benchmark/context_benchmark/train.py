...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train context-benchmark tabular models on split-aware real+synthetic benchmark datasets."
    )
    parser.add_argument(
        "--build-run-dir",
        type=Path,
        default=None,
        help="Path to a built context_benchmark dataset run. Defaults to the latest build run.",
    )
    parser.add_argument(
        "--experiment-names",
        nargs="+",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Optional training output root. Defaults to the context_benchmark artifacts/training root.",
    )
    parser.add_argument(
        "--label-scheme",
