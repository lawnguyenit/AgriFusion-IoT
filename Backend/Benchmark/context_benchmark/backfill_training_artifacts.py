...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate prediction-level and scientific artifacts for an existing context-benchmark training run."
    )
    parser.add_argument(
        "--train-run-dir",
        type=Path,
        required=True,
        help="Path to an existing context_benchmark training run directory.",
    )
